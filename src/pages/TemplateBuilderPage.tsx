...
import { useTemplate, useAddTemplateExercise, useRemoveTemplateExercise } from '@/hooks/useTemplates'
      ...
      <PageContainer>
        <div className="py-4 space-y-3">
          ...
          {template?.template_exercises.map((te) => (
            <div key={te.id} className="flex items-center gap-3 rounded-xl border border-border bg-card p-4">
